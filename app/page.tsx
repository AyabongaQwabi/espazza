      ...
      >
        ...
        <div className='relative z-10 text-center px-4 pt-16'>
          ...
          <p className='text-xl md:text-6xl text-gray-300 mb-4 font-bold'>
            iApp yomRepha besiXhosa
          </p>
          <p className='text-2xl text-gray-400 mb-8 max-w-2xl mx-auto'>
            The ultimate platform for Xhosa Hip Hop artists to connect, share,
      ...
      <div className='py-20 px-4 bg-gray-900'>
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 gap-8'>
            <ArtistCard name='Dee Koala' image='/deekoala.jpg' />
            <ArtistCard name='K Keed' image='/kkeed.jpg' />
            <ArtistCard name='Flash Ikumkani' image='/flash.jpg' />
            <ArtistCard name='Driemanskap' image='/driemanskap.jpg' />
          </div>
        </div>
      </div>
