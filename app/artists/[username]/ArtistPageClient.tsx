...
import { Mail, Phone, Calendar, MapPin, Music, Award, Users } from 'lucide-react';
...
export default function ArtistPageClient({ artist }: { artist: Profile }) {
  return (
    <div className="min-h-screen bg-zinc-900 text-white">
      ...
      >
        <div
          ...
          style={{
            backgroundImage: `url(${
              artist.gallery_images[0] || artist.profile_image_url || DEFAULT_IMAGE
            })`,
            filter: 'blur(5px)',
          }}
        />
        ...
        <div className="relative z-10 text-center">
          ...
          >
            <Image
              ...
              alt={`${artist.artist_name} profile photo`}
              width={250}
              height={250}
      ...
      >
        ...
        <p className="text-zinc-400 mb-8">Fan interaction features coming soon...</p>
          ...
          <div className="mt-12">
            ...
            <ul className="space-y-4">
              <li className="bg-zinc-800 p-6 rounded-lg transition-all duration-300 hover:bg-zinc-700">
                ...
                <p className="text-zinc-400">Check back later for future events!</p>
              </li>
            </ul>
          </div>
        )}
      ...
      >
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-8">Support {artist.artist_name}</h2>
