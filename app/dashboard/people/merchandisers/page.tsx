      ...
      >
        <Card className='bg-zinc-900 border-zinc-800'>
          <CardHeader>
            ...
            <CardDescription>
              All registered merchandise sellers
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
                  ...
                  <TableBody>
                    {merchandisers.map((merchandiser) => (
                      <TableRow key={merchandiser.id}>
                        ...
                        <TableCell>
                          {new Date(merchandiser.created_at).toLocaleDateString(
                            'en-ZA'
                          )}
                        </TableCell>
                        <TableCell>
                          <Dialog>
                            <DialogTrigger asChild>
                              <Button
                                variant='outline'
                                size='sm'
                                onClick={() => viewMerchandiser(merchandiser)}
                              >
                                View Details
                              </Button>
                            </DialogTrigger>
                            <DialogContent className='sm:max-w-[700px]'>
                              ...
                              <div className='grid gap-4 py-4'>
                                ...
                                <div>
                                  ...
                                  {merchandiser.images &&
                                  merchandiser.images.length > 0 ? (
                                    <div className='grid grid-cols-3 gap-2'>
                                      {merchandiser.images.map(
