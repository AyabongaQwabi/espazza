...
const navItems = [
  ...
  { href: '/dashboard/promotion', icon: UserIcon, label: 'iiTracks Zakho' },
  { href: '/dashboard/purchases', icon: UserIcon, label: 'Music Bought' },
  { href: '/dashboard/balances', icon: UserIcon, label: 'Balances' },
  { href: '/dashboard/tickets', icon: UserIcon, label: 'Tickets Bought' },
