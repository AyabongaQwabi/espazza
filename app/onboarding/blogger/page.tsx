...
export default function BloggerOnboarding() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Success',
        description: 'Your blogger profile has been updated.',
      });
      router.push('/dashboard');
    } catch (error) {
      console.error('Error updating blogger profile:', error);
      toast({
        title: 'Error',
        description: 'Failed to update blogger profile. Please try again.',
        variant: 'destructive',
      });
    }
  };
  ...
  return (
    <div className='max-w-2xl mx-auto p-4'>
      <h1 className='text-2xl font-bold mb-4'>Blogger Information</h1>
