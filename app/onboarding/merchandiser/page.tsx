...
export default function MerchandiserOnboarding() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Success',
        description: 'Your merchandiser profile has been updated.',
      });
      ...
      toast({
        title: 'Error',
        description: 'Failed to update merchandiser profile. Please try again.',
        variant: 'destructive',
      });
    }
  };
  ...
  return (
    <div className='max-w-2xl mx-auto p-4'>
      <h1 className='text-2xl font-bold mb-4'>Merchandiser Information</h1>
        ...
        <div className='bg-zinc-900 rounded-lg p-6 space-y-4'>
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setFormData({ ...formData, product_types: e.target.value })
              }
              required
              placeholder='e.g., T-shirts, Hats, Posters'
            />
          </div>
          <div>
